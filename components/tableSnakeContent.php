...
echo "<tr>
        ...
        echo "
              <a href='index.php?page=famille&id=" . $animal["id_animal"] ."' type='button' id='btn-getFamille' class='btn btn-list' style='background-color: #F27438;'><i class='bi bi bi-house-fill'></i></a>
              <a type='button' id='btn-selectionLoveRoom' class='btn btn-list' style='background-color: #0B486B' onclick='checkSnakeSelected(" . $animal["id_animal"] . ", " .$animal["genre"] .")'><i class='bi bi-arrow-through-heart-fill'></i></a>
