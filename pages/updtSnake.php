        ...
        <h1 class="fw-bold mb-0">Bienvenu dans la création d'un serpent</h1>
          ...
          <div class="row mb-4 mt-5">
              <div class="col">
                  ...
                  <div class="range">
                      <input name="duree_vie_minute" type="range" class="form-range" id="customRange1" min="1" max="15"/>
                  </div>
              </div>
              <div class="col">
                  <label class="form-label" for="customRange1">Merci d'indiquer son espérance de vie en seconde</label>
                  <div class="range">
                      <input name="duree_vie_seconde" type="range" class="form-range" id="customRange1" min="0" max="60"/>
                  </div>
              </div>
          </div>
